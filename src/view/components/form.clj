...
(defn contact-form [{:keys [title desc convention mod] :or {mod :light}}]
  (let [classes (case mod
                  :light ["" "input_l" "checkbox_l" "button_d shadow_22 c_dark" "/img/newsletter_l.svg"]
                  :dark ["c_dark" "input_d" "checkbox_d" "button_yellow bg_yellow c_light" "/img/newsletter_d.svg"])
    ...
    [:div.contact_form.my_48
     [:div
      ...
      [:div.flex.align_c
       [:img.mr_12 {:width 100 :height 100 :src img-src}]
