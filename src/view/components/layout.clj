...
(defn- contact-tab []
  [:div.sticky.top_0.z_50.bg_d_blur
   [:div.container.flex.align_c.justify_e.c_dark.py_4
    [:img {:decoding "async" :alt "email" :width 16 :src "/svg/mail_l.svg"}]
    [:a.c_dark.mr_14.ml_6.fs_14_sm {:href "mailto:info@raeumungsmeister.de"} "info@raeumungsmeister.de"]
    [:img {:decoding "async" :alt "phone" :width 16 :src "/svg/phone_l.svg"}]
    [:span.ml_6.fs_13_sm "+49 155 61383039"]]])
...
(defn- footer []
  [:footer.container
   ...
   [:div.flex.flex_wrap.align_c.justify_sb
    [:span.c_social.mb_20.mr_32 "© 2025 räumungsmeister"]

    [:div.flex.align_c.justify_e.mb_20
     [:a.flex.c_social {:target "_blanc" :href "https://www.linkedin.com/in/sander2411"}
     ...
     [:a.flex.c_social.ml_20 {:target "_blanc" :href "https://twitter.com/@AlexanderOlsha3"}
