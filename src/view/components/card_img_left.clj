(ns view.components.card-img-left)
...
(defn card-img-left []
  [:div.card_img_left.bg_light.border_r_12.my_24
   [:div.card_img_left_text.p_60_res
    ...
    [:p "Unsere Nachlassauflösung bietet Ihnen eine einfühlsame und professionelle Lösung. Wir kümmern uns um die Entsorgung von Erbstücken und hinterlassen Ihre Räume besenrein. Vertrauen Sie auf unsere Expertise für einen respektvollen und effizienten Abschluss."]]
