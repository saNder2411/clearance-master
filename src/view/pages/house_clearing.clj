...
(defn house-clearing-page [route]
  (layout route
          [:main
           ...
           [:div.bg_yellow
            [:div.container.py_0
             (smooth-testimonials {:img-src "/img/temp-img-01.png"
             ...
             (smooth-testimonials {:img-src "/img/private-cleaning-1-h600.png"
             ...
             (smooth-testimonials {:img-src "/img/private-cleaning-3-r.png"
             ...
             (smooth-testimonials {:img-src "/img/our-goal.png"
